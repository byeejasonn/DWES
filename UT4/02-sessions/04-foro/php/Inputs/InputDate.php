...
?>
        <div class="input">
            ...
            <input type="<?= $this->type ?>" name="<?= $this->name ?>" id="<?= str_replace("_", " ", $this->name) ?>" min="<?= $this->mindate->format("Y-m-d") ?>" max="<?= $this->maxdate->format("Y-m-d") ?>" value="<?= ($this->data != null)?$this->data:'' ?>" required>
