<?php
    ...
    if (isset($_POST['thread'])) {
        ...
        if($form->esValido() && isset($_SESSION['user'])) {
    ...
    <div class="content-wrapper">
        ...
        <div class="content-section">
            ...
            <article>
                ...
                <h3 class="blog-title">Gracias</h3>
                <p>Ya he conseguido pasarme a Hornet, estuvo complicado, muchas gracias, lo recominedo, 5 estrellas</p>
                <a href="#header">Volver al inicio</a>
            </article>
            <article>
                <div class="blog-header">
                ...
                <p>Aiuda no consigo pasarme a Hornet</p>
                <a href="#header">Volver al inicio</a>
            </article>
            <article>
                <div class="blog-header">
                    <h4 class="user">Ersaga</h4>
                    <span class="date">14/05/2020</span>
                </div>
                <h3 class="blog-title">Principios</h3>
                <p>Hollow Knight puede ser confuso al principio, pero aquí dejo uan guía de que hacer para empezar. Tambien se puede seguirun camino propio.<br>
                    1.Llega a Bocasucia. <br>
                    2.Vence al Falso Caballero. <br>
                    3. Consigue el hechizo espiritu vengativo para matar al baldur anciano que protege la entrada a Sendero Verde. <br>
                    4.Vence a Hornet. Por el camino es recomendado cojer el diario del cazador. <br>
                    5.Conseguir garra de Mantis <br>
                    6.Mejora el aguijon en Ciudad de Lágrimas <br>
                    7.Vence a los Señores de las Mantis <br>
                    8.Vence al Maestro de Almas <br>
                    9.Usa el hechizo salto desolador para entrar en Cumbre de cristal, o compra la linterna de lumelula. <br>
                    10.Consigue el Corazon de Cristal <br>
                    11.Ve a Tierras de Reposo y consigue el Aguijon Onírico. <br>
                    Despues de esto, ya puedes hacer casi todo.</p>
                    <a href="#header">Volver al inicio</a>
            </article>
        </div>
    </div>
